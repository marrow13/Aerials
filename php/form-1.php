...
function emailFormSubmission()
{
	...
	$message .= 'Имя'.  "\r\n";
	$message .= 'Имя:' . htmlentities($_REQUEST["contact_name"],ENT_COMPAT,'UTF-8').  "\r\n";

	$message .= 'Email:' . htmlentities($_REQUEST["contact_email"],ENT_COMPAT,'UTF-8').  "\r\n";

	$message .= 'Телефон:' . htmlentities($_REQUEST["contact_phone"],ENT_COMPAT,'UTF-8') . "\r\n" ;
	$message .= 'Сообщение:' . htmlentities($_REQUEST["contact_message"],ENT_COMPAT,'UTF-8').  "\r\n";
	...
	$headers = 'От кого:   marrow@ukr.net' . "\r\n" . '' . $formEmail .  "\r\n" .'' . phpversion() . "\r\n" . '' . "\r\n";
